...
<div style="text-align:center;"><img src="/assets/papers/optical_model.png" align="center" height="280px"></div>
...
从几何上看，上文的大气散射模型说明了在 RGB 颜色空间当中，向量\\( A \\)、\\( I(x) \\)和\\( J(x) \\)是共面的，而且它们的终点应该是共线的，如下图：

![](/assets/papers/optical_model_geo.png)
